(function ($) {
	...
	if($('.active-sticky-header').length){
		...
		function setHeaderHeight(){
	 		$("header.active-sticky-header").css("height", $('header.active-sticky-header .header-sticky new-sticky').outerHeight());
		}	
	
		$window.on("scroll", function() {
			var fromTop = $(window).scrollTop();
			setHeaderHeight();
			var headerHeight = $('header.active-sticky-header .header-sticky new-sticky').outerHeight()
			$("header.active-sticky-header .header-sticky new-sticky").toggleClass("hide", (fromTop > headerHeight + 100));
			$("header.active-sticky-header .header-sticky new-sticky").toggleClass("active", (fromTop > 600));
		});
	}	
	...
	$window.on( "load", function(){
		if( $(".project-item-list").length ) {
			...
			// Set default filter to the active tab's filter
			var $activeTab = $(".project-nav a.active-btn");
			if ($activeTab.length) {
				var defaultFilter = $activeTab.attr('data-filter');
